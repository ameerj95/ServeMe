...
router.get('/generatestaff', async function (req, res) {
    const staff_qr = {
    kitchen:{qr:`http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${configdata.CLIENT_URL}/kitchen`,
            url:`${configdata.CLIENT_URL}/kitchen`},
    manager:{qr:`http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${configdata.CLIENT_URL}/manager`,
            url:`${configdata.CLIENT_URL}/manager`},
    bar:{qr:`http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${configdata.CLIENT_URL}/bar`,
            url:`${configdata.CLIENT_URL}/bar`},
    waiter:{qr:`http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${configdata.CLIENT_URL}/waiter`,
